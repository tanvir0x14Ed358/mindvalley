...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createTask: function createTask() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/tag', this.tag).then(function (res) {
        _this2.tag.name = '';
        _this2.edit = false;
    ...
    deleteTask: function deleteTask(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete('api/tag/' + id).then(function (res) {
        _this3.fetchTaskList();
      }).catch(function (err) {
        return console.error(err);
      });
        ...
        _c("div", { staticClass: "container" }, [
          _c(
            ...
            [
              ...
              _c(
                "router-link",
                { staticClass: "nav-link", attrs: { to: { name: "tag" } } },
                [_vm._v("Tag")]
              )
            ],
            1
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-2 text-center" }, [_vm._v("Id")]),
      _vm._v(" "),
      _c("div", { staticClass: "col-md-8 text-center" }, [_vm._v("Name")]),
      _vm._v(" "),
      _c("div", { staticClass: "col-md-2 text-center" })
    ])
  }
...
/* harmony import */ var _components_Tag__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Tag */ "./resources/js/components/Tag.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  routes: [{
    ...
    path: '/tag',
    name: 'tag',
    component: _components_Tag__WEBPACK_IMPORTED_MODULE_5__["default"],
    props: {
      title: "Tag Listing"
    }
  }]
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/vueadmin.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\projects\mindvalley\medium\resources\js\vueadmin.js */"./resources/js/vueadmin.js");
